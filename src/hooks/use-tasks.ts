...
export const useTasks = () => {
  ...
  const [priorityFilter,<dyad-write path="src/hooks/use-tasks.ts" description="Custom hook for task state management with local storage persistence">
import { useState, useEffect, useMemo } from 'react';
import { Task, SortOption, FilterOption, Category, Priority } from '@/types/task';
import { isToday, isAfter, parseISO, startOfDay } from 'date-fns';
...
export const useTasks = () => {
  ...
  return {
    <dyad-write path="src/hooks/use-tasks.ts" description="Completing the useTasks hook">
import { useState, useEffect, useMemo } from 'react';
import { Task, SortOption, FilterOption, Category, Priority } from '@/types/task';
import { isToday, isAfter, parseISO, startOfDay } from 'date-fns';

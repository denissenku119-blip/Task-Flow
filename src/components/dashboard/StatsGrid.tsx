 ...
 return (
  <div className="grid grid-cols-2 lg:grid-cols-4 gap-3">
   {items.map((item, index) => (
    ...
    >
     <Card className="p-4 border-slate-200 dark:border-slate-800 hover:shadow-md transition-shadow rounded-xl h-full flex flex-col">
      <div className={`p-2 rounded-xl ${item.bg} ${item.color} w-fit mb-3`}>
       <item.icon size={20} />
      </div>
